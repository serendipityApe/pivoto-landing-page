...
const mockActions: Action[] = [
  {
    id: "dashboard",
    title: "Pivoto Dashboard",
    // desc: "View main dashboard",
    action: "switch-tab",
    CustomIcon: (
    ...
    url: "https://pivoto.dashboard.com",
    domain: "pivoto.dashboard.com",
    active: true,
  },
  {
    id: "settings",
    ...
    url: "https://pivoto.settings.com",
    domain: "pivoto.settings.com",
    active: false,
  },
  {
    id: "analytics",
    title: "Analytics",
    // desc: "View analytics data",
    action: "switch-tab",
    CustomIcon: (
      <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
    ...
    url: "https://pivoto.analytics.com",
    domain: "pivoto.analytics.com",
    active: false,
  },
  {
    id: "profile",
    title: "Profile",
    // desc: "View profile settings",
    action: "switch-tab",
    url: "https://pivoto.profile.com",
    domain: "pivoto.profile.com",
    CustomIcon: (
      <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
